...
const $f8bcbfe18e2fe7d0$export$8709c598d43be649 = async (formData)=>{
    const spaCommand = window["spaCommand"];
    const file = formData.get("files[]");
    if (file && spaCommand) {
        // const filesData = await spaCommand('preuploadFile', { files: [file] });
        // const fileIds = filesData.map((i) => i.id);
        // formData.append('fileIds', JSON.stringify(fileIds));
        const formData1f = new FormData();
        formData1f.append(`file-0`, file, file.name);
        const res = await $f8bcbfe18e2fe7d0$export$52e83573e7782585(`/api/files/upload/ToPreUploadedFiles`, "post", formData1f);
        const fileIds = res.data.map((i)=>i.preUploadFileId);
        formData.append("fileIds", JSON.stringify(fileIds));
    }
...
const $f81a3911e4a82254$export$c4554bcf2294fa00 = (props)=>{
    ...
    (0, $dRi2I.useLayoutEffect)(()=>{
        if (isOpened) return;
        setData({
            ...$f81a3911e4a82254$var$DEFAULT_DATA,
            name: user?.name || "",
            email: user?.email || ""
        });
        setErrors({});
    ...
    return /*#__PURE__*/ (0, $77e8d50d2e3c37d8$exports.jsx)((0, $90553183ddec9bac$export$2e2bcd8739ae039), {
        ...
        children: /*#__PURE__*/ (0, $77e8d50d2e3c37d8$exports.jsxs)("div", {
            ...
            children: [
                ...
                !!data?.name && /*#__PURE__*/ (0, $77e8d50d2e3c37d8$exports.jsxs)("fieldset", {
                    className: (0, (/*@__PURE__*/$parcel$interopDefault($90882d80f8e6b385$exports))).fieldset,
                    children: [
                        /*#__PURE__*/ (0, $77e8d50d2e3c37d8$exports.jsx)((0, $487baaaca1734e92$export$2e2bcd8739ae039), {
                            id: "Help name",
